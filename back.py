...
def main():
    ...
    default_path = "/Users/darshanv/All Files/Tanmai/biriyani.jpg" if os.name == "posix" else r"C:\Users\91910\Downloads\biriyani.jpg"
    image_path = input(f"Enter the image path (default: {default_path}): ") or default_path
